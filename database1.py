    ...
    while retries < MAX_RETRIES:
        try:
            connection = pymysql.connect(
               host="museum-db.czc02syc8orz.ap-south-1.rds.amazonaws.com",
                user="root",
    ...
    while retries < MAX_RETRIES:
        try:
            connection = mysql.connector.connect(
                host='museum-db.czc02syc8orz.ap-south-1.rds.amazonaws.com',  # Replace with your MySQL host
                user='root',  # Replace with your MySQL username
                password='Heysiri1207',  # Replace with your MySQL password
...
if __name__ == "__main__":
    ...
    print(fetch_museum_data_by_category("Archeology Museum"))
